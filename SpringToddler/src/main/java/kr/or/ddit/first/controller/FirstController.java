...
//@Controller
public class FirstController implements ApplicationContextAware{ // ApplicationContextWare : 웹애플리케이션 컨텍스트 -> Bean 취득 가능
	// http://localhost/SpringToddler/first/hello.first
	@RequestMapping("/first/hello.first") // 실질적으로 주소창에 사용하는 URI?
	public String firstMethod(){
		System.out.println("FirstController의 firstMethod() 콜백");
		return "first/hello"; // jsp 경로
	}
	...
	public void setApplicationContext(ApplicationContext webApplicationContext)
		...
		System.out.print(m1.getMem_regno1() + " | ");
		System.out.println(m1.getMem_regno2());
	}
}
