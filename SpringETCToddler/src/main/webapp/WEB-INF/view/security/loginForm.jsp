...
$(function(){
	...
	$('.loginBtn').click(function(){
		...
		$frm.attr('action','${pageContext.request.contextPath}/security/join/loginCheck.do');
		
		var $memId = $('<input type="hidden" name="mem_id" value="' + $('input[name=mem_id]').val() + '"></input>');
		$frm.append($memId);
		var $memPwd = $('<input type="hidden" name="mem_pass" value="' + $('input[name=mem_pass]').val() + '"></input>');
		$frm.append($memPwd);
